...
\usepackage{amsfonts, amssymb, amsmath, amsthm, booktabs, hyperref, pgfplots, tikz, xcolor, mathrsfs, multicol, array, polynom}
\usepackage{makeidx}
...
\begin{theorem}[The Division Algorithm]\label{theorem:2.2.1}\index{division algorithm}\index{division algorithm for polynomials}
...
\begin{definition}\label{definition:2.2.3}\index{zero}\index{root}
...
\begin{corollary}[The Factor Theorem]\label{corollary:2.2.4}\index{factor theorem}
...
\begin{definition}\label{definition:2.2.6}\index{greatest common divisor}
...
\begin{definition}\label{definition:2.2.7}\index{relatively prime}
...
\begin{proposition}[Bézout's Theorem]\label{proposition:2.2.8}\index{Bézout's Theorem}
